...
const TreeHelperClass = preload("res://addons/plugin_exporter_backport/src/class/tree_helper.gd") #>import tree_helper.gd
...
func _init() -> void:
	plugin_icon = _EIBackport.get_ins().ei.get_base_control().get_theme_icon("ActionCopy", &"EditorIcons")
...
func _ready() -> void:
	...
	file_icon = _EIBackport.get_ins().ei.get_base_control().get_theme_icon("File", &"EditorIcons")
	plugin_icon = _EIBackport.get_ins().ei.get_base_control().get_theme_icon("ActionCopy", &"EditorIcons")
...
const _BPSV_PATH_plugin_export_gui = "res://addons/plugin_exporter_backport/src/plugin_export_gui.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
