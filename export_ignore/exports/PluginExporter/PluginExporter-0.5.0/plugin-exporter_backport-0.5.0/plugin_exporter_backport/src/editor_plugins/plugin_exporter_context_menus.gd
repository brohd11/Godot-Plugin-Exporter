extends EditorContextMenuPluginCompat
...
static func add_exported_flag(script_editor):
	var line = script_editor.get_caret_line()
	var text = script_editor.get_line(line)
	script_editor.insert_text_at_caret("const PLUGIN_EXPORTED = true")
...
const _BPSV_PATH_plugin_exporter_context_menus = "res://addons/plugin_exporter_backport/src/editor_plugins/plugin_exporter_context_menus.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
