extends "res://addons/plugin_exporter_backport/src/class/remote/tree_helper_base.gd"


func _set_folder_icon_img():
	folder_icon = _EIBackport.get_ins().ei.get_base_control().get_theme_icon("Folder", &"EditorIcons")
	folder_color = _EIBackport.get_ins().ei.get_base_control().get_theme_color("folder_icon_color", "FileDialog")
...
const _BPSV_PATH_tree_helper = "res://addons/plugin_exporter_backport/src/class/tree_helper.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
