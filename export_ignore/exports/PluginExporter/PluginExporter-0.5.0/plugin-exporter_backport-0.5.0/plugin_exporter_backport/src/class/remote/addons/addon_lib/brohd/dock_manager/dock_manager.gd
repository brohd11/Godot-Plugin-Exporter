...
const DockPopupHandler = preload("res://addons/plugin_exporter_backport/src/class/remote/addons/addon_lib/brohd/dock_manager/dock_popup/dock_popup_handler.gd")
const Docks = preload("res://addons/plugin_exporter_backport/src/class/remote/addons/addon_lib/brohd/alib_editor/utils/src/editor_nodes/docks.gd")
const BottomPanel = preload("res://addons/plugin_exporter_backport/src/class/remote/addons/addon_lib/brohd/alib_editor/utils/src/editor_nodes/bottom_panel.gd")
const _MainScreenHandlerClass = preload("res://addons/plugin_exporter_backport/src/class/remote/addons/addon_lib/brohd/dock_manager/class/main_screen_handler.gd")
const MainScreenHandlerMultiClass = preload("res://addons/plugin_exporter_backport/src/class/remote/addons/addon_lib/brohd/dock_manager/class/main_screen_handler_multi.gd")
const PanelWindow = preload("res://addons/plugin_exporter_backport/src/class/remote/addons/addon_lib/brohd/dock_manager/class/panel_window.gd")
...
func post_init():
	...
	if "dock_button" in plugin_control:
		...
		dock_button.icon = _EIBackport.get_ins().ei.get_base_control().get_theme_icon("MakeFloating", &"EditorIcons")
...
func _on_window_mouse_exited():
	_EIBackport.get_ins().ei.get_base_control().get_window().grab_focus()
...
const _BPSV_PATH_dock_manager = "res://addons/plugin_exporter_backport/src/class/remote/addons/addon_lib/brohd/dock_manager/dock_manager.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
