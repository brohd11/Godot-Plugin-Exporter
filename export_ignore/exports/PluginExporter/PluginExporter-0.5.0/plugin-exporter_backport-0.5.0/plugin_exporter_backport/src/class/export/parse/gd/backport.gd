...
const MISC_BACKPORT_PATH = "res://addons/plugin_exporter_backport/src/class/export/backport/misc_backport_class.gd"
const MISC_BACKPORT = "MiscBackport"

const Backport4_0 = preload("res://addons/plugin_exporter_backport/src/class/export/parse/gd/backport/4_0_backports.gd")
var backport4_0:Backport4_0

const BackportContext = preload("res://addons/plugin_exporter_backport/src/class/export/parse/gd/backport/context_menu.gd")
var backport_context:BackportContext

const BackportStaticVar = preload("res://addons/plugin_exporter_backport/src/class/export/parse/gd/backport/static_var_backport.gd")
var backport_static_var:BackportStaticVar

const Backport4_4 = preload("res://addons/plugin_exporter_backport/src/class/export/parse/gd/backport/4_4_backports.gd")
var backport4_4:Backport4_4

const MiscBackportParse = preload("res://addons/plugin_exporter_backport/src/class/export/parse/gd/backport/misc_backport.gd")
...
const _BPSV_PATH_backport = "res://addons/plugin_exporter_backport/src/class/export/parse/gd/backport.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
