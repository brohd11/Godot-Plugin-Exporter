...
const _UtilsRemote = preload("res://addons/plugin_exporter_backport/src/class/utils_remote.gd") #>remote
...
const _BPSV_PATH_export_data = "res://addons/plugin_exporter_backport/src/class/export/export_data.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
