...
static func _run_export_script(script_path, func_name):
	...
	_EIBackport.get_ins().ei.get_base_control().add_child(script_ins)
...
const _BPSV_PATH_plugin_exporter_file_utils = "res://addons/plugin_exporter_backport/src/class/export/plugin_exporter_file_utils.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
