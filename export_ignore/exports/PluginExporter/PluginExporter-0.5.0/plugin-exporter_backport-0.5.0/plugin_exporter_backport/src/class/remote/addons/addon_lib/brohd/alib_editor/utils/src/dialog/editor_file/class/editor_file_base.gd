...
func _set_root_node(_root_node):
	if _root_node == null:
		_root_node = _EIBackport.get_ins().ei.get_base_control()
...
const _BPSV_PATH_editor_file_base = "res://addons/plugin_exporter_backport/src/class/remote/addons/addon_lib/brohd/alib_editor/utils/src/dialog/editor_file/class/editor_file_base.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
