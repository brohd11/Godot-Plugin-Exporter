...
const EditorNodes = preload("res://addons/plugin_exporter_backport/src/class/remote/addons/addon_lib/brohd/alib_editor/utils/src/u_editor_nodes.gd")
...
static func create_context_plugin_items(plugin:EditorContextMenuPluginCompat, script_editor, menu_items:Dictionary, context_menu_callable):
...
const _BPSV_PATH_popup_wrapper = "res://addons/plugin_exporter_backport/src/class/remote/addons/addon_lib/brohd/popup_wrapper/popup_wrapper.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
