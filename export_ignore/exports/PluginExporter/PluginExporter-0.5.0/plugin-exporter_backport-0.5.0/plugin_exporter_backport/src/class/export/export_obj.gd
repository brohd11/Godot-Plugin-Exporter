const _UtilsRemote = preload("res://addons/plugin_exporter_backport/src/class/utils_remote.gd")
const _UEditor = _UtilsRemote.UEditor
const _UtilsLocal = preload("res://addons/plugin_exporter_backport/src/class/utils_local.gd")
...
func sort_valid_files():
	for file in valid_files_for_transfer.keys():
...
func get_file_dependencies():
	...
	for remote_path in file_dependencies.keys():
...
const _BPSV_PATH_export_obj = "res://addons/plugin_exporter_backport/src/class/export/export_obj.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
