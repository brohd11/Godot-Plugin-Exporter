...
const BACKPORT_STATIC_PATH = "res://addons/plugin_exporter_backport/src/class/export/backport/sv_backport.gd"
...
func pre_export():
	...
	for file_path in export_obj.files_to_copy.keys():
...
# Simulate building the rule for "Plugin.instance"
	...
	var line1 = "if not is_instance_valid(Plugin.get_instance()):"
	var line2 = "var dock_manager = Plugin.get_instance().new_gui_instance()"
...
const _BPSV_PATH_static_var_backport = "res://addons/plugin_exporter_backport/src/class/export/parse/gd/backport/static_var_backport.gd"
### PLUGIN EXPORTER STATIC VAR BACKPORT
