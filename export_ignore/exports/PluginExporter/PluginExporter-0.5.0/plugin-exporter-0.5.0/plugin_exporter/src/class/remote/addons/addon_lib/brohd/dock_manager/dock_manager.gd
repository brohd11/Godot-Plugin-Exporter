...
const DockPopupHandler = preload("res://addons/plugin_exporter/src/class/remote/addons/addon_lib/brohd/dock_manager/dock_popup/dock_popup_handler.gd")
const Docks = preload("res://addons/plugin_exporter/src/class/remote/addons/addon_lib/brohd/alib_editor/utils/src/editor_nodes/docks.gd")
...
const _MainScreenHandlerClass = preload("res://addons/plugin_exporter/src/class/remote/addons/addon_lib/brohd/dock_manager/class/main_screen_handler.gd")
const MainScreenHandlerMultiClass = preload("res://addons/plugin_exporter/src/class/remote/addons/addon_lib/brohd/dock_manager/class/main_screen_handler_multi.gd")
const PanelWindow = preload("res://addons/plugin_exporter/src/class/remote/addons/addon_lib/brohd/dock_manager/class/panel_window.gd")
